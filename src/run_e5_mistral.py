...
def main():
    ...
    parser.add_argument("--model", type=str, default=os.environ.get("E5_MODEL", r"/home/jiaxin/e5-mistral-7b-instruct"))
    ...
    outputs_dir = Path(cfg["outputs_dir"]) / "e5"
    bins_dir = Path(cfg.get("bins_dir", "bin"))
    logs_dir = Path(cfg["logs_dir"]) / "e5"
